...
export const MENU_SIDEBAR: MenuConfig = [
  ...
  { heading: 'Finances' },
  { title: 'Mes factures', icon: Receipt, path: '/dashboard?tab=invoices' },
  { title: 'Facturation', icon: CreditCard, path: '/dashboard?tab=billing' },
  { title: 'Parrainage', icon: UserPlus, path: '/dashboard?tab=referral' },
];
